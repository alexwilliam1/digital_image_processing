...
def load_images3():
    ...
    for i, value in enumerate(list_path):
        ...
        cv.imwrite(
            '/home/alex/Área de Trabalho/BLUE/ISIC/NaoMelanoma/ISIC_BLUE%d.png' % cont, blue)
        cv.imwrite(
            '/home/alex/Área de Trabalho/RED/ISIC/Melanoma/ISIC_RED%d.png' % cont, red)
        cv.imwrite(
            '/home/alex/Área de Trabalho/GREEN/ISIC/Melanoma/ISIC_GREEN%d.png' % cont, green)
        cont += 1
        print(value)
