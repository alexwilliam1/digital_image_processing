...
def lbp(img, transformed_img, i):
    for x in range(0, len(img)):
        for y in range(0, len(img[0])):
            ...
            values = thresholded(center, [
                                 top_left, top_up, top_right, right, bottom_right, bottom_down, bottom_left, left])
    ...
    NoMelanoma(transformed_img, i)


def Melanoma(img_lbp, i):
    cv2.imwrite(
        "/home/alex/Área de Trabalho/teste_lbp/ImgLBP_{:>04}.png".format(i), img_lbp)
    print("PH2 - LBP MELANOMA", i+1)


def NoMelanoma(img_lbp, i):
    cv2.imwrite(
        "/home/alex/Área de Trabalho/PH2/LBP/NãoMelanoma/ImgLBP_{:>04}.png".format(i), img_lbp)
