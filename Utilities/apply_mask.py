...
def main():
    img = read_images(
        "/home/alex/Área de Trabalho/teste_lbp/ISIC/NãoMelanoma/*.png")
    mask = read_masks(
        "/home/alex/Documentos/TCC2/ISIC/MascaraNaoMelanoma/*.png")
...
def apply(img, mask, i):
    ...
    cv2.imwrite(
        "/home/alex/Área de Trabalho/a/ImgLBP_{:>03}.png".format(i), res)
